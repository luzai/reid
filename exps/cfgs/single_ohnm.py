...
cfgs = [
    ...
    # edict(
    #     logs_dir='senet.init_senet.dop.0.25.cdm.worker8.2',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cdm',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     dataset_val='cuhk03', batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
    ...
    # ),
    # edict(
    #     logs_dir='senet.init_senet.dop.0.25.cdm.worker8.longer.2',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cdm',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     dataset_val='cuhk03', batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
    #     steps=[65, 85], epochs=90,
    #     workers=8,
    #     dataset_mode='combine',
    #     dropout=0,
    #     cls_weight=0, tri_weight=1,
    ...
    # ),
    # edict(
    #     logs_dir='senet.init_senet.cdm.worker8.2',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cdm',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     dataset_val='cuhk03', batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
