...
cfgs = [
    ...
    #     area=(0.85, 1),
    #     dataset_val='cuhk03',
    #     batch_size_l=[8, 16, 32, 64, 128],
    #     num_instances_l=[2, 4, 4, 4, 4],
    #     bs_steps=[50, 100, 150, 200, 250, 415],
    #     num_classes=128,
    #     print_freq=1,
    #     gpu=range(1),
    #     evaluate=False,
    ...
    edict(
        logs_dir='nopretrain.gradual.long',
        arch='resnet50',
        dataset='cuhk03',
        global_dim=512,
        lr=2e-3,
        ...
        area=(0.85, 1),
        dataset_val='cuhk03',
        batch_size_l=[8, 16, 32, 64, 96, 128],
        num_instances_l=[2, 4, 4, 4, 4, 4],
        bs_steps=[50, 100, 150, 200, 300, 400, 500],
        num_classes=128,
        print_freq=1,
        gpu=range(1),
        evaluate=False,
