...
cfgs = [
    ...
    # ),
    edict(
        logs_dir='cuhk03label.se.concat.dop.bak',
        arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
        dataset='cuhk03', dataset_val='cuhk03', eval_conf='cuhk03',
        lr=3e-4, margin=0.5, area=(0.85, 1),
        batch_size=64, num_instances=4, gpu=range(1), num_classes=128,
        steps=[40, 60], epochs=65,
        workers=8,
        dataset_mode='label',
        dropout=0.25,
    ...
    # ),
    # edict(
    #     logs_dir='cuhk03detect.se.concat.35',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cuhk03', dataset_val='cuhk03', eval_conf='cuhk03',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
    ...
    # ),
    # edict(
    #     logs_dir='cuhk03detect.se.concat.45',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cuhk03', dataset_val='cuhk03', eval_conf='cuhk03',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
    ...
    # ),
    # edict(
    #     logs_dir='cuhk03detect.se.concat.dop',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='cuhk03', dataset_val='cuhk03', eval_conf='cuhk03',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
    ...
    # ),
    # edict(
    #     logs_dir='market1501.se.concat.dop',
    #     arch='resnet50', block_name='SEBottleneck', block_name2='SEBottleneck',
    #     dataset='market1501', dataset_val='market1501', eval_conf='market1501',
    #     lr=3e-4, margin=0.5, area=(0.85, 1),
    #     batch_size=128, num_instances=4, gpu=range(1), num_classes=128,
