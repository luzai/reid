...
class CPN(nn.Module):
    def __init__(self, resnet, output_shape, num_class, pretrained=True, args=None):
        ...
        self.refine_net = refineNet(channel_settings[-1], output_shape, num_class, args)
...
def CPN50(out_size, num_class, pretrained=True, args=None):
...
def CPN101(out_size, num_class, pretrained=True, args=None):
